<?php
    ...
    if(isset($_POST['change'])){
        ...
        $sql ="SELECT Password FROM employee_table WHERE EmailId=:username and Password=:password";
        ...
        if($query -> rowCount() > 0){
            $con="update employee_table set Password=:newpassword where EmailId=:username";
                    ...
                    <div class="col s12 m12 l6">
                        <div class="card">
                            <div class="card-content">
                                <div class="row" style ="width =1000 px">
                                    <form class="col s12" name="chngpwd" method="post">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="input-field col s12">
                                            <button type="submit" name="change" style ="color:white ; background-color:green ;margin-left:400px;"  class="waves-effect waves-light btn  m-b-xs" onclick="return valid();  ">Change</button>
