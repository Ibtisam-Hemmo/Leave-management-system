    ...
    if(strlen($_SESSION['emplogin'])==0) {// no more than one session at the same time.
        header('location:index.php');
            ...
            if(isset($_POST['apply'])){
                ...
                $sql="INSERT INTO leaves_table(LeaveType,ToDate,FromDate,Description,Status,IsRead,empid) VALUES(:leavetype,:fromdate,:todate,:description,:status,:isread,:empid)";
                                                    ...
                                                    <div class="wizard-content">
                                                        <div class="row">
                                                            <div class="col m12">
                                                                ...
                                                                <button type="submit" name="apply" id="apply" style ="color:white ; background-color:green ;margin-left:400px" class="waves-effect waves-light btn  m-b-xs">Apply</button>                                             
                                                </div>
                                            </div>
                                        </section>                                                                                               
                                        </section>
