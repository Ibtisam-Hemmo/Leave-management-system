...
if(strlen($_SESSION['emplogin'])==0){   // no more than one session at the same time.
    header('location:index.php');
        ...
        if(isset($_POST['update'])){
            ...
            $sql="update employee_table set FirstName=:fname,LastName=:lname,Gender=:gender,Dob=:dob,Department=:department,Address=:address,City=:city,Country=:country,Phonenumber=:mobileno where EmailId=:eid";
...
<html lang="en">
    ...
    <body>
        ...
        <main class="mn-inner">
            <div class="row">
                <div class="col s12">
                    <div class="page-title" style="color:green; font-weight:bold;">Update employee Details</div>
                </div>
                                            ...
                                            <div class="row">
                                                <div class="col m6">
                                                    <div class="row">
                                                        <?php 
                                                            $eid=$_SESSION['emplogin'];
                                                            $sql = "SELECT * from  employee_table where EmailId=:eid";
                                                            $query = $dbh -> prepare($sql);
                                                            $query -> bindParam(':eid',$eid, PDO::PARAM_STR);
                                                            $query->execute();
                                                        ...
                                                        <div class="input-field col  s12">
                                                            <label for="empcode">Employee Username</label>
                                                        ...
                                                        <?php $sql = "SELECT DepartmentName from department_menu";
                                                        $query = $dbh -> prepare($sql);
                                                        $query->execute();
                                                        $results=$query->fetchAll(PDO::FETCH_OBJ);
                                                        $cnt=1;
