...
<div class="input-field col s12">
<button type="submit" name="change" style ="background-color:green ; margin-left:300px" class="waves-effect waves-light btn  m-b-xs" onclick="return valid();">Change</button>
