...
$sql="update employee_table set FirstName=:fname,LastName=:lname,Gender=:gender,Dob=:dob,Department=:department,Address=:address,City=:city,Country=:country,Phonenumber=:mobileno where id=:eid";
                        ...
                        <div class="card">
                            <div class="card-content">
                                <form id="example-form" method="post" name="updatemp">
                                    <div>
                                        <h3 style="color:green" >Update Employee Details</h3>
...
<?php 
$eid=intval($_GET['empid']);
$sql = "SELECT * from  employee_table where id=:eid";
$query = $dbh -> prepare($sql);
$query -> bindParam(':eid',$eid, PDO::PARAM_STR);
$query->execute();
...
<div class="input-field col s12">
<button type="submit" name="update"  id="update" style = "background-color:green"class="waves-effect waves-light btn  m-b-xs">UPDATE</button>
