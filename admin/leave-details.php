...
$sql = "SELECT leaves_table.id as lid,employee_table.FirstName,employee_table.LastName,employee_table.EmpId,employee_table.id,employee_table.Gender,employee_table.Phonenumber,employee_table.EmailId,leaves_table.LeaveType,leaves_table.ToDate,leaves_table.FromDate,leaves_table.Description,leaves_table.PostingDate,leaves_table.Status,leaves_table.AdminRemark,leaves_table.AdminRemarkDate from leaves_table join employee_table on leaves_table.empid=employee_table.id where leaves_table.id=:lid";
$query = $dbh -> prepare($sql);
...
<tr>
 <td colspan="5">
  <a class="modal-trigger waves-effect waves-light btn" href="#modal1" style="background-color: #09B035;">Take&nbsp;Action</a>
<form name="adminaction" method="post">
<div id="modal1" class="modal modal-fixed-footer" style="height: 60%">
    <div class="modal-content" style="width:90%">
        <h4 style="color: #09B035;">Leave take action</h4>
    ...
    <div class="modal-footer" style="width:90%">
       <input type="submit" class="waves-effect waves-light btn blue m-b-xs" name="update" value="Submit" style="background-color: #09B035 !important;">
    </div>
